...
const CheckOut = ({setOrder}) => {
  ...
  const [shippongInfo, setShippingInfo] = useState({
    address: '',
    city: '',
    zip : '',
  })
  ...
  const handleOrder = () => {
    const newOrder = {
      ...
      orderNumber : "12345",
      shippingInformation : shippongInfo,
            ...
            <div className={`space-y-4 ${shippingToggle ? "" : "hidden"}`}>
              <div>
                ...
                <input
                  ...
                  className='w-full px-3 py-2 border'
                  onChange={(e) => setShippingInfo({...shippongInfo, address: e.target.value})}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className='w-full px-3 py-2 border'
                  onChange={(e) => setShippingInfo({...shippongInfo, city: e.target.value})}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className='w-full px-3 py-2 border'
                  onChange={(e) => setShippingInfo({...shippongInfo, zip: e.target.value})}
                />
              </div>
            </div>
          </div>
